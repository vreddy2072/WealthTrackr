-- Rollback Migration: Remove bank connections tables
-- Description: Removes tables for bank connection information
...
-- Remove has_online_connection column from accounts table
...
SELECT id, name, type_id, institution_id, balance, currency, is_active, notes, created_at, updated_at
FROM accounts;
